...
1. **30 juni 2026 — abonnementsplicht (URGENT, maintainer-actie, geen code).** Standard Tier-developers hebben vanaf deze datum een Strava-abonnement nodig om de API te blijven gebruiken; actieve developers krijgen 3 maanden gratis. Zonder actie valt de Strava-sync uit. Standard Tier dekt tot 10 athletes self-service — ruim genoeg voor persoonlijk gebruik. → **Abonnement regelen / gratis periode claimen vóór 30 juni.**
