...
**Suggested order:** 62.1 + 62.2 (form validation) ✅, 62.3 + 62.5 (permission visibility) ✅, 62.4 (sync edge paths) ✅ done; only **62.6** (strict concurrency, standalone PR) remains to close the epic.
