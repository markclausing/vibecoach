...
**Effort gerealiseerd (46.1 + 46.3):** ~3u (waarvan ~2u debugging UI-tests-launch op runner-environment). 46.2 is na dry-run uitgesteld naar een losse cleanup-PR (zie story-tekst).

**Status:** 🔄 — 46.1 + 46.3 live op `feature/epic-46-actions-dag-split`. 46.2 staat geparkeerd in afwachting van een `chore/swiftlint-cleanup`-voorbereidings-PR. Backlog-stories (46.B1–B6) blijven onaangeraakt.
